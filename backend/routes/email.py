...
_FALLBACK_HEADER = (
    ...
    '<span style="display:inline-block;vertical-align:middle;border-radius:3px;'
    'background:#ef5822;margin:0 8px 6px 0">'
    ...
    'View &amp; Accept or Decline</a></span>'
    '<span style="display:inline-block;vertical-align:middle;font-size:12px">'
    '<span style="font-weight:bold">{{refNumber}} - {{projectName}}</span>'
    '<br><span>{{total}}</span></span>'
    '</td></tr>'
    '<tr><td valign="center">'
