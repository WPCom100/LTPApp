    ...
    EB.prototype.render = function() {
      ...
      if (this.state.hasError) {
        ...
        return h("div", { style: { background: (B.danger || "#e74c3c") + "08", border: "1px solid " + (B.danger || "#e74c3c") + "33", borderRadius: "8px", padding: "20px 24px", margin: "8px 0" } },
          ...
          this.state.showDetails && h("div", { style: { background: (B.bg || "#1B262C"), border: "1px solid " + (B.border || "#333"), borderRadius: "6px", padding: "10px 12px", overflow: "auto", maxHeight: 200 } },
