...
(function() {
  ...
  function ProductForm({ initial, onSave, onCancel, onDelete, settings, qbo }) {
    ...
    window.LTP_useRecordWatch("products", initial && initial.id,
  ...
  window.QuotesProducts = function({ products, setProducts, quotes, settings, qbo }) {
    ...
    return h("div", null,
      ...
      isMobile && !showAdd && editingId == null && h(window.LTPFab, { label: "Add product", onClick: function() { setShowAdd(true); setEditingId(null); } }),
